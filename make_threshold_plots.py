...
script_file = "/home/fasig/scalable_radio_array/threshold_plotter.py"
options = [script_file] + sys.argv[1:]
...
job = Job("threshold_plotter", "/home/fasig/anaconda3/bin/python",
